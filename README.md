...
`POST /api/v1/users/:username/profile/follow`
...
`DELETE /api/v1/users/:username/profile/follow`

Authentication required, returns a Profile

No additional parameters required

### View profiles I follow

`GET /api/v1/users/me/profile/followings`

Authentication required, returns a list of profiles

No additional parameters required

### View profiles that follow me

`GET /api/v1/users/me/profile/followers`
